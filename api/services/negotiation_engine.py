...
def evaluate_offer(req: EvaluateOfferRequest, round_number: int) -> EvaluateOfferResponse:
    ...
    def with_round(resp: EvaluateOfferResponse) -> EvaluateOfferResponse:
        return resp.model_copy(update={"round_number": rnd})
